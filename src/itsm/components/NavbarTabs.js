...
export default function NavbarTabs({
  ...
  /* ------------------------------------------------------------------
   * Scroll helpers (for desktop arrows + internal scroll state)
   * ------------------------------------------------------------------ */
    ...
    <>
      <Box
        sx={{
          ...
          borderColor: "divider",
          minWidth: 0,
          overflow: "hidden", // 🔒 this row never pushes the layout horizontally
        }}
      >
        {/* Left scroll button (desktop only, only when needed) */}
        {!isMobile && (
          <Box
            sx={{
              width: 26,
          ...
          >
            {canScrollLeft && (
              <IconButton
                ...
                sx={{ p: 0.25 }}
              >
                {/* just using "<" via unicode to keep it minimal */}
        ...
        {/* Middle area: scrollable tabs + fixed + button */}
        <Box
          sx={{
            flex: 1,
            minWidth: 0,
        ...
        >
          ...
          <Box
            ...
            sx={{
              ...
              display: "flex",
              alignItems: "stretch",
              overflowX: "auto",          // ✅ actual horizontal scroll lives here
              overflowY: "hidden",
              WebkitOverflowScrolling: "touch",
              "&::-webkit-scrollbar": {
                height: 0,                // hide small tab scrollbar; main page scrollbar still OK
              },
            }}
          >
            {tabs.map((tab, idx) => {
          ...
          {/* + Add tab – fixed at the right edge of the tab bar, never scrolls off */}
          <Box
            sx={{
              flexShrink: 0,
              display: "flex",
        ...
        {/* Right scroll button (desktop only, only when needed) */}
        {!isMobile && (
          <Box
            sx={{
              width: 26,
